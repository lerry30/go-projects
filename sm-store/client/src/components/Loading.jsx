...
const Loading = ({ customStyle }) => {
    ...
    useEffect(() => {
        ...
        function drawSingleCircle(x, y, brightness) {
            context.fillStyle = `rgba(251, 54, 1, ${brightness})`;
            context.beginPath();
    ...
    return (
        <div className={ `flex justify-center items-center fixed top-0 left-0 right-0 bottom-0 z-50 backdrop-blur-sm dark:bg-neutral-950/80 ${ customStyle }` }>
